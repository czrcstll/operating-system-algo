 ...
 * @author Patrick Tria
 */
public class LOOKGUI extends javax.swing.JFrame {

    /**
     * Creates new form LOOKGUI
     */
    public LOOKGUI() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LOOKGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
