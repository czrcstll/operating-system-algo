 ...
 * @author Patrick Tria
 */
public class CSCANGUI extends javax.swing.JFrame {

    /**
     * Creates new form CSCANGUI
     */
    public CSCANGUI() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CSCANGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
