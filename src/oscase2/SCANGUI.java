 ...
 * @author Patrick Tria
 */
public class SCANGUI extends javax.swing.JFrame {

    /**
     * Creates new form SCANGUI
     */
    public SCANGUI() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SCANGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
