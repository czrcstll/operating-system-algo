 ...
 * @author Patrick Tria
 */
public class SSTFGUI extends javax.swing.JFrame {

    /**
     * Creates new form SSTFGUI
     */
    public SSTFGUI() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SSTFGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
